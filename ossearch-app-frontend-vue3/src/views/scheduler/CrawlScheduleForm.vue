        ...
        <div class="row g-3 mb-3">
          <div class="col-md-6">
            <div class="form-floating">
              <input v-model="jobData.jobName" type="text" class="form-control" id="validationDefault01" required placeholder="description" :disabled="disableChangeCollection">
...
<!--            <input class="form-control" list="datalistOptions" id="exampleDataList" :value="jobData.collectionName" @input="selectCollection($event.target.value)" placeholder="Type to search...">
            ...
            <div class="form-floating">
              <select class="form-select" id="floatingCollectionSelect" aria-label="select collection" :value="jobData.collectionName" @change="selectCollection($event.target.value)" :disabled="disableChangeCollection">
                <option v-for="(collection, i) in collections" :key="i" :value="collection.name">{{collection.name}}</option>
              </select>
...
<!--        <div class="float-end">
      ...
      <div class="card-body">
        <CollectionCrawlScheduleForm v-if="jobData?.jobName === jobData?.collectionName"
...
<!--        <div class="float-end">
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <div class="row g-3 mb-3">
          <div class="form-floating">
            <input v-model="jobData.nutchProperties['parser.html.blacklist']" type="text" class="form-control" id="parserhtmlblacklistt" required placeholder="description">
            <label for="parserhtmlblacklistt" class="form-label">{{ getProperty('parser.html.blacklist') }}</label>
          </div>
        </div>
        <div class="row g-3 mb-3">
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <div class="row g-3 mb-3">
          <div class="form-floating">
            <input v-model="jobData.nutchProperties['parser.html.whitelist']" type="text" class="form-control" id="parserhtmlwhitelistt" required placeholder="description">
            <label for="parserhtmlwhitelistt" class="form-label">{{ getProperty('parser.html.whitelist') }}</label>
          </div>
        </div>
        <div class="row g-3 mb-3">
...
export default {
  ...
  methods: {
    ...
    getCrawlConfig(id, name){
      CollectionService.getCollections('/collection/' + id + '/crawlConfig')
          .then(res => {
    ...
    updateCrawlOptions(event) {
      ...
      if ("num_threads" in event) {
        // console.log("num_threads in event", event)
        ...
        // console.log("num_threads not in event", this.jobData.nutchStepArgs)
        if (this.jobData.nutchStepArgs?.['fetch'] && 'threads' in this.jobData.nutchStepArgs?.['fetch']) {
          // console.log("fetch threads delete from step args", event)
          delete this.jobData.nutchStepArgs['fetch']['threads']
        }
        if ('fetch' in this.jobData.nutchStepArgs && Object.keys(this.jobData.nutchStepArgs['fetch']).length === 0) {
          // console.log("fetch delete from step args", event)
          delete this.jobData.nutchStepArgs['fetch']
        }

        if (this.jobData.nutchStepArgs?.['sitemap'] && 'threads' in this.jobData.nutchStepArgs?.['sitemap']) {
          // console.log("sitemap threads delete from step args", event)
          delete this.jobData.nutchStepArgs['sitemap']['threads']
        }
        if ('sitemap' in this.jobData.nutchStepArgs && Object.keys(this.jobData.nutchStepArgs['sitemap']).length === 0) {
          // console.log("sitemap delete from step args", event)
      ...
      if ("size_fetchlist" in event) {
        ...
        if (this.jobData.nutchStepArgs?.['generate'] &&'topN' in this.jobData.nutchStepArgs?.['generate']) {
          delete this.jobData.nutchStepArgs['generate']['topN']
        }
        if ('generate' in this.jobData.nutchStepArgs && Object.keys(this.jobData.nutchStepArgs['generate']).length === 0) {
      ...
      if ("dedup_group" in event) {
        ...
        if (this.jobData.nutchStepArgs?.['dedup'] && 'group' in this.jobData.nutchStepArgs?.['dedup']) {
          delete this.jobData.nutchStepArgs['dedup']['group']
        }

        if ('dedup' in this.jobData.nutchStepArgs && Object.keys(this.jobData.nutchStepArgs['dedup']).length === 0) {
