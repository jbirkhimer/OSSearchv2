      ...
      <tr th:attr="data-id=${item.jobId}">
        ...
        <td style="text-align: center;">
          <div class="btn-group text-center" role="group"
            ...
            <button type="button" class="btn btn-success btnRun">Run Once</button>
            <button type="button" class="btn btn-secondary btnPause">Pause</button>
            <button type="button" class="btn btn-secondary btnResume">Resume</button>
