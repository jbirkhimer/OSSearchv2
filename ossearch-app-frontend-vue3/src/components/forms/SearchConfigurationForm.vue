<template>
  ...
  <div class="row g-3">
    <div class="col-md-6">
      <label for="validationDefault08" class="form-label">Include Response Fields</label>&nbsp;<a role="button"
                                                                                                  class="bi-info-circle-fill"
                                                                                                  data-bs-toggle="collapse"
                                                                                                  data-bs-target="#collapseIncludeFieldsInfo"
                                                                                                  aria-expanded="false"
                                                                                                  aria-controls="collapseIncludeFieldsInfo"></a>
...
export default {
  ...
  props: ['responseType', 'resultsPerPage', 'resultLimit', 'includeFields'],
  components: {
    ImportAddEditCheckTable
  },
  data() {
