      ...
      if ("meta".equalsIgnoreCase(node.getNodeName())) {
        ...
        if (nameNode != null) {
          if (contentNode != null) {
            ...
            if (Nutch.ROBOTS_METATAG.equals(name.toLowerCase())) {
