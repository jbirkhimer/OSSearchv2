...
public class DOMContentUtils {
  ...
  private boolean getTextHelper(StringBuffer sb, Node node,
    ...
    while (walker.hasNext()) {
        ...
        for (int i = 0; i < attrs.getLength(); i++) {
          ...
          if ("class".equalsIgnoreCase(attr.getNodeName())) {
            ...
            for (int j = 0; j < tagClasses.length; j++) {
              ...
              if (tagClasses[j].equalsIgnoreCase("robots-noindex") || tagClasses[j].equalsIgnoreCase("element-invisible") || tagClasses[j].equalsIgnoreCase("browsenav") || tagClasses[j].equalsIgnoreCase("header-nav") || tagClasses[j].equalsIgnoreCase("footer")) {
                walker.skipChildren();
              }
          ...
          if ("id".equalsIgnoreCase(attr.getNodeName())) {
            ...
            if ("robots-noindex".equalsIgnoreCase(attr.getNodeValue()) || "chat-notification".equalsIgnoreCase(attr.getNodeValue()) || "skip-main".equalsIgnoreCase(attr.getNodeValue()) || "skip-link".equalsIgnoreCase(attr.getNodeValue()) ) {
              walker.skipChildren();
            }
      ...
      if ("nav".equalsIgnoreCase(nodeName)) {
        walker.skipChildren();
      }
      if ("footer".equalsIgnoreCase(nodeName)) {
        walker.skipChildren();
      }*/
