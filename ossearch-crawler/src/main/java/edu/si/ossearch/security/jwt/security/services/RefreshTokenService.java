package edu.si.ossearch.security.jwt.security.services;
...
import edu.si.ossearch.security.jwt.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
  @Value("${ossearch.jwt.refreshExpirationMs}")
