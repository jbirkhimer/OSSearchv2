...
import edu.si.ossearch.security.jwt.repository.*;
...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        // == create initial user
        createUserIfNotFound("admin@si.edu", "firstName", "lastName", "admin", adminPassword, true, new HashSet<>(Arrays.asList(adminRole)));
